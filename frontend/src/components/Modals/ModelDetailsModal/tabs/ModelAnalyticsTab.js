// src/components/Modals/ModelDetailsModal/tabs/ModelAnalyticsTab.js
...
const ModelAnalyticsTab = ({ usageHistory = [], viewMode }) => {
  ...
  useEffect(() => {
    ...
    // Store a reference to the current element to avoid the React hooks warning
    ...
    if (typeof ResizeObserver === "undefined") {
      ...
      const parentWidth = currentChartContainer.offsetWidth;
      const parentHeight = currentChartContainer.offsetHeight;
    ...
    const initialWidth = currentChartContainer.offsetWidth;
    const initialHeight = currentChartContainer.offsetHeight;
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <YAxis 
                  ...
                  tick={{ fill: "var(--text-color, #A0AEC0)" }}
                  domain={() => {
                    // Use the getMetricMinMax function to set appropriate Y-axis range
                    const { min, max } = getMetricMinMax(selectedMetric);
